...
useEffect(() => {
  if (product) {
    setFormData({
      ...
      conversionFactor: product.conversionFactor !== undefined ? String(product.conversionFactor) : '',
      minQuantity: product.minQuantity !== undefined ? String(product.minQuantity) : '',
