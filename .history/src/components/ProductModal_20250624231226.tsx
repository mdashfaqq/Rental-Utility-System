...
const productData = {
  ...
  price: parseFloat(formData.price), // optional, if your API uses it
  stock: parseInt(formData.stock),
  unit: formData.unit,
  small_unit: formData.smallUnit || null,
  conversion_factor: formData.conversionFactor ? parseFloat(formData.conversionFactor) : null,
