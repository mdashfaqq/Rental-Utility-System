...
export const VendorMaster = () => {
  ...
  const handleEdit = (vendor: any) => {
    ...
    toast({
      title: 'Vendor Edited',
      description: 'The vendor details have been successfully edited.',
      variant: 'default', // optional: makes it red
      duration: 3000,
    });
  };
  ...
  const handleAdd = () => {
    ...
    toast({
      title: 'Vendor Edited',
      description: 'The vendor details have been added successfully edited.',
      variant: 'default', // optional: makes it red
      duration: 3000,
    });
  };
