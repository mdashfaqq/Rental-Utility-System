...
export const Dashboard = () => {
  ...
  return (
    <div className="space-y-10 pt-5 md:pt-10 transition-all duration-300">
      {/* Header */}
      <div className="flex items-center justify-between">
        <h1 className="text-3xl font-bold text-gray-1000">{t('Welcome to Grocery POS')}</h1>
        {user && (
          <div className="flex items-center mt-2 text-lg text-gray-600">
            <UserIcon className="h-5 w-5 mr-2" />
            <span>Hello, <span className="font-semibold text-gray-800">{user. emailname}</span></span>
          </div>
        )}
        <div className="text-sm text-gray-500">
          {new Date().toLocaleDateString()}
